package com.example.testingtiramisu.notificationruntimepermission
...
class TestingNotificationRuntimePermissionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_testing_notification_runtime_permission)
