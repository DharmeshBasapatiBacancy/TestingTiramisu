package com.example.testingtiramisu.downgradablepermissions
...
class TestingDowngradablePermissionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_testing_downgradable_permission)
