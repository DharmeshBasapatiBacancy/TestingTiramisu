package com.example.testingtiramisu.photopicker
...
class TestingPhotoPickerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_testing_photo_picker)
